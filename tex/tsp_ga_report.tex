...
\documentclass[twoside,twocolumn]{article}
  ...
  Consider the following image. The problem lies in finding the shortest path visiting all vertices once. For example the path $1$:${A,C;D,B,A}$ and $2$:${A,B,C,D,A}$ pass all the vertices once, but path $1$ has a length of $108$ and path $2$, $97$.\linebreak
