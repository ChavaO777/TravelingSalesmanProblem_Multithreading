...
\taburowcolors[2]{white .. black!20}
  ...
  \hline
  20 & \textcolor{red}{56045.310} & 56012.943\\
  \cline{2-3}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.50\textwidth]{output1_1_singleThread_10Cities.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.50\textwidth]{output2_1_singleThread_15Cities.jpg}
\caption{Output of the single-threaded program with $15$ cities as input}
\end{figure} 

\begin{figure}[H]
\centering
\includegraphics[width=0.50\textwidth]{output2_2_multiThread_15Cities.jpg}
\caption{Output of the multi-threaded program with $4$ cores and $15$ cities as input}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.50\textwidth]{output3_1_singleThread_20Cities.jpg}
\caption{Output of the single-threaded program with $20$ cities as input}
\end{figure} 

\begin{figure}[H]
\centering
\includegraphics[width=0.50\textwidth]{output3_2_multiThread_20Cities.jpg}
